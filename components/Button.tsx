...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    outline: "border-2 border-indigo-500/50 hover:border-indigo-500 text-indigo-400 bg-transparent",
    accent: "bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-400 hover:to-purple-500 text-white shadow-xl shadow-purple-500/20"
  };
